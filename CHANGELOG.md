...
### Changed
- Classify demographics fields as OpenClaw standard (creature, emoji, vibe) vs OP extension (8 fields)
- Clarify that `name` in Demographics is a convenience copy; canonical source is ProfileData.name
- Update MCP tool descriptions and README with standard/extension distinction
